...
class EditaskScreen extends StatelessWidget {
  const EditaskScreen({Key? key}) : super(key: key);
      ...
      child: Scaffold(
          appBar: CustomTheme.appBar(
            title: TextCustom.heading2(
                text: 'Edit Kerjaan', color: ColorsCustom.textPrimary),
          ),
          body: SafeArea(
                ...
                () => Form(
                  ...
                  child: ListView(
                    children: [
                      ...
                      FormBuilderDropdown(
                        initialValue:
                            taskController.categoryController.value.text,
                      ...
                      FormBuilderSwitch(
                          validator: FormBuilderValidators.compose([
                            (val) {
                              if (val!) {
                                if (DateTime.parse(taskController
                                        .startDateController.value.text)
                                    .isBefore(DateTime.now())) {
                                  return 'Waktu mulai harus diatas waktu sekarang';
                                }
                              }
                            }
                          ]),
                      ...
                      SizedBox(
                          ...
                          child: ButtonPrimary(
                            ...
                            onPressed: () => taskController.updateData(
                                status: taskController.task.value.status!),
                          )),
                    ],
                  ),
                ),
